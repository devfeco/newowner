  ...
  return (
    <div className="space-y-6">
      <p className="text-gray-600 mb-4">
        Sosyal medya hesaplarınız ve takipçi sayılarınızı paylaşın. Bu bilgiler, markanızın dijital varlığı hakkında alıcılara fikir verecektir.
      </p>

      <div className="space-y-6">
        {socialPlatforms.map(platform => (
          <div key={platform.id} className="p-5 border border-gray-200 rounded-lg">
            <div className="flex items-center mb-4">
              <div className={`flex items-center justify-center w-9 h-9 rounded-full mr-3 text-white ${platform.color}`}>
                {platform.icon}
              </div>
            ...
            <div className="ml-12">
              <div className="flex items-center mb-4">
                ...
                />
                <label htmlFor={`has-${platform.id}`} className="ml-2 text-sm font-medium text-gray-900">
                  {platform.name} hesabı mevcut
                </label>
              </div>
